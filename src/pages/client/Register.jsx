  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 flex flex-col items-center justify-center p-6">
      ...
      <div className="card p-8 w-full max-w-md shadow-xl shadow-pink-100/50">
        <h1 className="font-display text-2xl font-bold text-gray-900 mb-1">Créer un compte</h1>
        <p className="text-sm text-gray-500 mb-7">Rejoignez Planty pour réserver vos soins beauté</p>
        ...
        <Link to="/client/salons" className="btn-primary block text-center py-3 mt-6">
          Créer mon compte
        </Link>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          Déjà un compte ?{' '}
          <Link to="/client/connexion" className="text-primary-500 font-semibold hover:underline">Se connecter</Link>
        </p>
      </div>

      <p className="text-xs text-gray-400 mt-8 text-center">
        Vous êtes un professionnel ?{' '}
        <Link to="/inscription" className="text-primary-500 hover:underline">Espace instituts →</Link>
      </p>
    </div>
  )
}